...
function ErrorPage() {
  return (
    <div className="h-[100vh] w-full bg-[#1f1f1f] ">
      ...
      <section className="flex justify-center h-[90vh] items-center max-sm:h-[70vh]">
        <div className="text-[#bababa] max-sm:flex max-sm:flex-col">
          <h1 className="text-6xl mb-2 font-bold max-sm:text-2xl max-sm:text-center max-sm:mb-1">
            404 Error
          </h1>
          <p className="tracking-wider max-sm:text-base max-sm:text-center max-sm:mb-2">
