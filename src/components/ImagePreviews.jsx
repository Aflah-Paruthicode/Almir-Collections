                ...
                <div className="flex flex-wrap gap-2">
                    {images.map((url) => (
                        <div className='relative' key={url.lastModified+url.size}>
                            <button onClick={''} className='bg-[#000000a7] rounded-[50%] absolute top-0 right-0 cursor-pointer p-1'><svg xmlns="http://www.w3.org/2000/svg" height="22px" viewBox="0 -960 960 960" width="22px" fill="#e3e3e3"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></button>
