...
export const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Yes, we provide COD for some products of these, across India . You can pay after receiving the product.",
  },
  {
    question: "What if the product is damaged or defective?",
    answer:
      "We offer a replacement guarantee. If your product is damaged on arrival through taking an opening video, we’ll replace it",
  },
  {
    question: "How long does delivery take?",
    answer:
      "Usually 2–4 working days within Kerala, depending on your location",
  },
  {
    question: "Can I return the product if I don’t like it?",
    answer:
      "We only replace defective or damaged products on the arrival, not returns for personal choice. Please check product details before ordering.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes! All photos are taken from our suppliers. What you see is what you get.",
  },
  {
...
export const ExtraFAQ = [
  {
    ...
    answer:
      "Sizes vary by product. For clothes, we usually have S, M, L, XL. For shoes, we have sizes 6–10 (sometimes 11). depends on product.",
  },
  {
    question: "How do I know my correct size?",
    answer:
      "If you are confused, just message us on WhatsApp with your usual size, and we’ll guide you.",
  },
];
...
export const productData = {
  ...
  category: "EARPHONE",
  description:
    "Enjoy premium sound without the premium price. The Marshall Mode XV ENC (Replica) delivers powerful audio, comfort, and style. Perfect for music, movies, and calls — all packed with awesome quality at just ₹1249.",
  highlightsArr: [
